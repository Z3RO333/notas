...
export function ComparativosFilters({
  ...
  return (
    <div className="flex flex-wrap items-center gap-3">
      ...
      >
        <SelectTrigger className="w-36" aria-label="Ano base">
      ...
      >
        <SelectTrigger className="w-40" aria-label="Ano comparado">
      ...
      >
        <SelectTrigger className="w-36" aria-label="Tipo de ordem">
