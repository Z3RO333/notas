...
export const metadata: Metadata = { title: 'Saída | Portal Operacional' }

export default async function OperacionalSaidaPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if ((s.operacional_codigo as string) !== opCodigo) notFound()
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-5">
      <div className="mb-5">
        <h1 className="text-lg font-semibold">Saída em andamento</h1>
        <p className="text-sm text-muted-foreground">Registre o resultado de cada ordem</p>
      </div>
      <SaidaView saida={saida} />
    </div>
  )
}
