-- 00143_fix_workspace_pmpl_owner_source.sql
--
-- Corrige a fonte do responsavel atual no painel de ordens.
-- Regressao atual:
-- - vw_ordens_notas_painel voltou a usar n.administrador_id como fonte unica
--   de responsavel_atual_id.
-- - Para PMPL isso zera o dono no workspace, porque a ordem e standalone
--   e o responsavel fica em ordens_notas_acompanhamento.administrador_id.
--
-- Regra restaurada:
-- - PMPL: dono atual = administrador da ordem.
-- - PMOS/outros: dono atual = administrador da nota, com fallback para
--   administrador da ordem.
...
COMMENT ON VIEW public.vw_ordens_notas_painel IS
  'Painel de ordens com responsavel atual derivado da ordem para PMPL e da nota para PMOS.';
