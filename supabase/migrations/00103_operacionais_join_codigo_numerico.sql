-- 00103_operacionais_join_codigo_numerico.sql
-- Corrige o JOIN entre ordens_notas_acompanhamento e dim_operacionais.
-- No SAP, o campo FORNECEDOR pode vir com sufixo de letra (ex: "22016E", "14606C").
-- dim_operacionais armazena apenas o código numérico puro (ex: "22016", "14606").
-- Solução: stripa caracteres não-numéricos do fornecedor_codigo na hora do JOIN.
