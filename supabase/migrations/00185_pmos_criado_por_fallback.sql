-- 00185_pmos_criado_por_fallback.sql
--
-- Restaura criado_por como fallback de responsavel_atual_id APENAS para PMOS.
-- PMPL permanece concentrado no administrador_id da ordem (Gustavo/Brenda).
--
-- Contexto: a migration 00092 havia implementado esse fallback com
-- COALESCE(n.administrador_id, o.administrador_id, o.criado_por), mas foi
-- removido acidentalmente quando 00168 reescreveu a view.
--
-- Efeito: ordens PMOS sem nota vinculada (ou nota sem admin) passam a aparecer
-- no painel de quem criou a ordem no SAP, reduzindo o KPI sem_responsavel.
