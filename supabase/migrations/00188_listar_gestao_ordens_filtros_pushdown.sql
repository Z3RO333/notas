-- Migration 00188: push texto_breve, tipo_unidade, limit filters into listar_gestao_ordens_base_filtrada
-- Previously the /api/graficos/servicos/ordens route fetched the full period dataset and
-- filtered/sorted in Node. This migration adds p_texto_breve, p_tipo_unidade, and p_limit
-- so the database handles the WHERE, ORDER BY, and LIMIT.
