-- Migration 00120: exclude notas com status_canonico CANCELADA/VIROU_ORDEM em notas_status_sap_aux
-- do calcular_metricas_notas_dashboard (mesmo filtro aplicado em vw_notas_sem_ordem)
...
AS $function$
  ...
  notas_base AS (
    SELECT
      ...
      -- NULL means no SAP aux record; any value means we have external status info
